module.exports = {
  'Filtering on search page': function (browser) {
    browser
      ...
      .pause(1000)
      .assert.urlEquals('http://localhost:8000/search/people?q=charles&filter%5Boccupation%5D=inventor&page%5Bsize%5D=50')
      .click('.filter__box[value=inventor]')
      .pause(1000)
      .click('.filter__box[value="England, United Kingdom"]')
      .pause(1000)
      .assert.urlEquals('http://localhost:8000/search/people?q=charles&filter%5Bbirth%5Bplace%5D%5D=England%2C+United+Kingdom&page%5Bsize%5D=50')
      .click('.filter__box[value="England, United Kingdom"]')
      .pause(1000)
      .assert.urlEquals('http://localhost:8000/search/people?q=charles&page%5Bsize%5D=50')
      .click('.filter__box[value="England, United Kingdom"]')
      ...
      .pause(1000)
      .assert.urlEquals('http://localhost:8000/search/people?q=charles&filter%5Boccupation%5D=chemist&filter%5Bbirth%5Bplace%5D%5D=England%2C+United+Kingdom&page%5Bsize%5D=50')
      .end();
  }
};
