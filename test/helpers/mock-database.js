...
module.exports = () => ({
  search: function () {
    ...
    if (getNestedProperty(arguments, '0.body.query.function_score.query.bool.must.multi_match.query')) {
      q = arguments[0].body.query.function_score.query.bool.must.multi_match.query;
